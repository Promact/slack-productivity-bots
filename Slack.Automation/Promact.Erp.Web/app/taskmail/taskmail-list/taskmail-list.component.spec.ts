...
//    class MockMd2Toaster { }
//    class MockMd2SelectChange { }
//    const routes: Routes = [];
//    beforeEach(async(() => {
...
//                { provide: Md2Toast, useClass: MockMd2Toaster },
//                { provide: Md2Toast, useClass: MockMd2SelectChange }
//            ]
//        }).compileComponents();
//    }));
...
//    it('Shows list of TaskReports on initialization', fakeAsync(() => done => {
//        this.promise.then(() => {
