...
namespace Promact.Core.Test
{
    public class TaskMailRepositoryTest
    {
        ...
        //    var taskMailDetail = await _taskMailRepository.TaskMailDetailsReportPreviousDate(user.Id, _stringConstant.FirstNameForTest, _stringConstant.RoleAdmin, Convert.ToString(DateTime.UtcNow), user.Id);
        //    Assert.Equal(1, taskMailDetail.Count);
        //}
