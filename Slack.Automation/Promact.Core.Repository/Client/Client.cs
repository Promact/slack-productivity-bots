...
namespace Promact.Core.Repository.Client
{
    public class Client : IClient
    {
        ...
        public Client(IOauthCallsRepository oauthCallRepository, IStringConstantRepository stringConstant, IEmailService email, IAttachmentRepository attachmentRepository,IHttpClientRepository httpClientRepository, IEnvironmentVariableRepository envVariableRepository)
        {
        ...
        {
            var teamLeaders = await _oauthCallRepository.GetTeamLeaderUserName(username, accessToken);
            var management = await _oauthCallRepository.GetManagementUserName(accessToken);
            var userDetail = await _oauthCallRepository.GetUserByUsername(username, accessToken);
