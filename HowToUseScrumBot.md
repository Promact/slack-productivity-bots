...
#### List of Rules and Limitations of Scrum meeting conducted by a scrum bot
  ...
  * No other conversations should be made in between the scrum meeting(in the case when scrum is not halted). If slack trigger words (like “scrum meeting” or “scrum help”) are used and slackbot/scrumbot makes a conversation (like “Yeah..It's scrum time” or with Help message) then that might hinder the scrum meeting. 
